...
public enum ChatExceptionCode implements ExceptionCode {
    ...
    INVALID_CHAT_ROOM_ID(HttpStatus.BAD_REQUEST, "CHAT4", "잘못된 채팅방 id입니다."),
    NOT_FOUNT_CHAT_ROOM_ID(HttpStatus.BAD_REQUEST, "CHAT5", "채팅방 id 가 없습니다."),
    UNAUTHENTICATED(HttpStatus.UNAUTHORIZED, "CHAT6", "인증되지 않은 사용자입니다."),
    ;
